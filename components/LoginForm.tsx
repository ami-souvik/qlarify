                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="appearance-none block w-full pl-12 pr-4 py-4 bg-slate-50 border border-[#EEE9E2] rounded-2xl shadow-inner placeholder-slate-300 focus:outline-none focus:ring-2 focus:ring-orange-100 focus:bg-white sm:text-sm transition-all font-medium"
                                />
                            </div>
                        </div>
